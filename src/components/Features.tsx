        ...
        <div className="mb-20 md:mb-32">
          <div className="border border-gray-300 rounded-xl overflow-hidden">
            <div className="grid md:grid-cols-2 gap-0 items-center">
              ...
              <div className="order-2 md:order-2 px-4 md:px-8 lg:px-12 py-4 md:py-6">
                ...
                <button className="bg-justpay-green text-white px-6 py-3 rounded-2xl font-semibold hover:bg-green-700 transition">
                  Redeem card
                </button>
              </div>
            </div>
